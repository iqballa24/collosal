...
import SquareArrowUp from '@/assets/square-arrow-up.svg';
import SquareCheck from '@/assets/square-check-circle.svg';
import SquareDownload from '@/assets/square-download.svg';
import SquareRefresh from '@/assets/square-refresh.svg';
      ...
      <section className="wrapper flex flex-col md:flex-row gap-16 items-center justify-between mb-36">
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="grid grid-cols-2 gap-5">
            <ItemIcon icon={SquareDownload} description="Back up every day" />
            <ItemIcon icon={SquareArrowUp} description="Upgrade" />
            <ItemIcon icon={SquareRefresh} description="Cleaning every week" />
